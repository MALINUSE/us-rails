...
!function (e) {
    ...
    f.prototype = {
        constructor: f, init: function (e) {
            ...
            var i = this, t = i.$previewContainer.find(".kv-fileinput-error");
            i.isError = !1, e ? t.fadeOut("slow") : t.remove()
        }, showError: function (e, i, t, a) {
            var n = this, r = n.$previewContainer.find(".kv-fileinput-error");
            ...
            for (var i, t, a = 0; a < l.length; a++)if (cat = l[a], i = v(cat, self.fileTypeSettings) ? self.fileTypeSettings[cat] : p[cat], t = i(e.type, e.name) ? cat : "", "" != t)return t;
            return "other"
        }, previewDefault: function (i, t) {
            var a = this, n = w.createObjectURL(i), r = e("#" + t), l = v("other", a.previewTemplates) ? a.previewTemplates.other : o.other;
            ...
            var a, n, r = this, l = r.parseFileType(e), p = e.name, c = r.allowedPreviewTypes, m = r.allowedPreviewMimeTypes, g = (e.type, v(l, r.previewTemplates) ? r.previewTemplates[l] : o[l]), f = v(l, r.previewSettings) ? r.previewSettings[l] : s[l], h = parseInt(r.wrapTextLength), b = r.wrapIndicator, y = r.$preview, C = c.indexOf(l) >= 0, $ = d(m) || !d(m) && v(e.type, m);
            if (C && $) {
                if ("text" == l) {
                    var x = i.target.result;
                    if (w.revokeObjectURL(a), x.length > h) {
                        var T = "text-" + u(), F = .75 * window.innerHeight, P = r.getLayoutTemplate("modal").replace(/\{id\}/g, T).replace(/\{title\}/g, p).replace(/\{body\}/g, x).replace(/\{height\}/g, F);
            ...
            function i(p) {
                ...
                var v = c + "-" + p, u = e[p], f = u.name, h = (u.size ? u.size : 0) / 1e3, b = w.createObjectURL(u);
                ...
                return t.showPreview ? void(n.length > 0 && "undefined" != typeof FileReader ? (o.html(s.replace(/\{index\}/g, p + 1).replace(/\{files\}/g, m)), l.addClass("loading"), r.onerror = function (e) {
                    ...
                    if (e.lengthComputable) {
                        var i = parseInt(e.loaded / e.total * 100, 10), t = d.replace(/\{index\}/g, p + 1).replace(/\{files\}/g, m).replace(/\{percent\}/g, i).replace(/\{name\}/g, f);
                        setTimeout(function () {
                            o.html(t)
                        }, 1e3)
                    }
            ...
            var t = this, a = t.$element, n = t.$preview, r = t.reader, l = t.$previewContainer, o = t.$previewStatus, s = t.msgLoading, d = t.msgProgress, c = (t.msgSelected, t.previewFileType, parseInt(t.wrapTextLength), t.wrapIndicator, "preview-" + u()), m = e.length, g = v("text", t.fileTypeSettings) ? t.fileTypeSettings.text : p.text;
            i(0)
        }, change: function (e) {
            var i, t = this, a = t.$element, n = a.val().replace(/\\/g, "/").replace(/.*\//, ""), r = 0, l = t.$preview, o = a.get(0).files, s = t.msgSelected, p = d(o) ? 1 : o.length + t.initialPreviewCount;

(function () {
    ...
    function xt(e, t, n) {
        ...
        return e.id = t, e.time = n, e.tween = function (t, n) {
            ...
            return Et(e, function (e, u, a) {
                ...
                var h = [], p = e.delay, d = e.duration, v = (e = e.node).__transition__ || (e.__transition__ = {
                        active: 0,
                        count: 0
                    }), m = e.__data__;
    ...
    var ts = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/, ns = d3.map({
        g: function (e, t) {
    ...
    var is = T(2), ss = T(3), os = function () {
        ...
        linear: os, poly: T, quad: function () {
            return is
        }, cubic: function () {
            return ss
        }, sin: function () {
        ...
        "in": x, out: E, "in-out": S, "out-in": function (e) {
            return S(E(e))
        }
    });
    d3.ease = function (e) {
    ...
    d3.svg.line.radial = function () {
        ...
        function e(e, i) {
            var s = t.call(this, e, i), o = n.call(this, e, i), u = (s.y + o.y) / 2, a = [s, {x: s.x, y: u}, {
                x: o.x,
                y: u
            }, o];
    ...
    d3.svg.axis = function () {
        ...
        var s = D(e, "brushstart", "brush", "brushend"), o = null, u = null, a = to[0], f = [[0, 0], [0, 0]], l;
    ...
    d3.geo.azimuthal = function () {
        ...
        var s = 4.5, o = Ur(s), u = d3.geo.albersUsa(), a = [], f = Rr({
    ...
    var To = d3.format("02d"), No = d3.format("03d"), Co = d3.format("04d"), ko = d3.format("2d"), Lo = pi(wo), Ao = pi(Eo), Oo = pi(So), Mo = di(So), _o = pi(xo), Do = di(xo), Po = {
        a: function (e) {
            return Eo[e.getDay()]
        }, A: function (e) {
            return wo[e.getDay()]
